...
public class ClassController {
    ...
    public String allClass(HttpSession session, Map<String, Object> map) {
        ...
        map.put("pageUrl", "system/adminclass/allclass");
    ...
    @RequestMapping(value = "/system/class/delete/{classId}", method = RequestMethod.GET)
    @ResponseBody
    public Boolean classDelete(@PathVariable("classId") Integer classId) {
        return classService.classDelete(classId);
    }
    /*没有分页*/
    ...
    @ResponseBody
    public Boolean studentDelete(@PathVariable("studentId") Integer studentId) {
        return classService.studentDelete(studentId);
    }
